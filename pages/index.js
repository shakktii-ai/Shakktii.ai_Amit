...
//         डेमो मतदानासाठी रेल्वे इंजिन निशाणी समोरील निळे बटन दाबावे
//     </button>
//     <p className="text-md font-medium mt-6">
//         मतदानाच्या दिवशी सुद्धा <span className="font-bold">रेल्वे इंजिन</span> या चिन्हासमोरील बटन दाबून <span className="font-bold">भरत मारुती गोगावले</span> यांना प्रचंड मतांनी विजयी करा !
//     </p>
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>श्री.अमित राज ठाकरे.</title>
      ...
      <div className="p-4 bg-white max-w-xl mx-auto text-center">
        <h1 className="text-lg font-semibold text-blue-800">
        181- माहिम विधानसभा सार्वत्रिक निवडणूक 2024
        </h1>
        ...
        <p className="text-md font-medium mt-6">
          मतदानाच्या दिवशी सुद्धा <span className="font-bold">रेल्वे इंजिन</span> या
          चिन्हासमोरील बटन दाबून{" "}
          <span className="font-bold">श्री.अमित राज ठाकरे</span> यांना प्रचंड मतांनी
          विजयी करा !
        </p>
        <div className="flex justify-center mt-6 ">
          <button
